...
VERSION = __import__('dxlfiletransferservice').get_version()
RELEASE_NAME = "dxlfiletransferservice-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxlfiletransferservice-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlfiletransferservice")])
...
print("\nRemoving dxlfiletransferservice.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlfiletransferservice.egg-info"))
