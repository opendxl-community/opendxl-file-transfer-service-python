...
with open(os.path.join(CWD, "dxlfiletransferservice", "_version.py")) as f:
...
setup(
    ...
    packages=[
        ...
        "dxlfiletransferservice._config",
        "dxlfiletransferservice._config.sample",
        "dxlfiletransferservice._config.app"],
    ...
    description="File Transfer DXL Python service",
